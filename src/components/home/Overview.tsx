...
import OverviewBox from "../../Form/OverviewBox";

interface OverviewProps {}

const Overview: FC<OverviewProps> = () => {
  return (
    <div className="mt-10 w-[1200px] h-[550px] ">
      <div className="flex flex-col justify-center items-center gap-y-6">
        <Title ttl="Penerration Testing Overview" />
        <div className="lg:w-[1200px] mt-20 h-[359px] grid lg:grid-cols-3 md:grid-cols-3 md:w-[780px] grid-row">
          <div >

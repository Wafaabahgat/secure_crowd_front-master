      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="mt-16 flex flex-col items-center justify-center">
          <Image
            ...
            width={650}
            height={446.76}
            className="mr-20 lg:w-[650px] md:w-[400px] sm:w-[350px]"
  
          />
          <Image src={Frame} alt="" className="lg:mt-[-250px] lg:w-[1203px] md:w-[900px] md:mt-[-185px] md:w-[900px] md:mt-[-185px]" />
        </div>

      </div>

      <div className="grid ml-6 mt-[-30px] gap-2 lg:w-[1200px] md:w-[260px]">
        <div className="flex">

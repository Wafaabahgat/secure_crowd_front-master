      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[1200px] h-[359px] grid grid-cols-3 ">
          <div className="w-[385px] h-[122px]">
            <h6 className="uppercase font-semibold flex text-center justify-center">test</h6>
            <Image src={overview1} alt="" />
          </div>
          <Image src={overviewI} width={352} height={341} alt="" />
          <div className="w-[385px] h-[122px]">
            <h6 className="uppercase font-semibold flex text-center justify-center">preporting</h6>
            <Image src={overview3} alt="" />
          </div>
          <div className="w-[385px] h-[122px]">
            <h6 className="uppercase font-semibold flex text-center justify-center">re-testing</h6>
            <Image src={overview2} alt="" />
          </div>
          <div className="w-[385px] h-[122px] " >
            <h6 className="uppercase font-semibold  flex text-center justify-center">review</h6>

  ...
  return (
    <div className="mt-32 w-[1200px] h-[550px] ">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="lg:w-[1200px] h-[359px] grid lg:grid-cols-3 sm:grid-cols-4">
          <div className="">
            <div className="lg:w-[400px] h-[122px] mb-[60px] md:w-[300px]">
              <h6 className="uppercase font-semibold text-xl flex text-center justify-center">
                test
              </h6>
              <Image src={overview1} alt="" width={385} />
            </div>
            <div className="lg:w-[400px] h-[122px] md:w-[300px] ">
              <h6 className="uppercase font-semibold text-xl flex text-center justify-center">
                re-testing
              </h6>

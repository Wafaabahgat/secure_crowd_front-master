    ...
    <div className="mt-32 w-[1200px] h-[700px] bg-gray-400">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="w-[1200px] h-[359px] grid grid-cols-3 ">
          <div className="w-[400px] h-[122px] bg-gray-50">
            <h6 className="uppercase font-semibold text-xl mb-2 flex text-center justify-center">
              test
            </h6>
          ...
          <div className="w-[400px] h-[122px]">
            <h6 className="uppercase font-semibold flex text-center justify-center">
              preporting
            </h6>
